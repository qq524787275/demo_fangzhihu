package com.feeljoy.library.widget.refreshview.swipe;


import android.support.v7.widget.RecyclerView;
import com.feeljoy.library.widget.refreshview.adapter.RefreshRecyclerviewViewHolder;
...
public class SwipeItemManagerImpl implements SwipeItemManagerInterface {
    ...
    private void initialize(RefreshRecyclerviewViewHolder targetViewHolder, int position) {
    ...
    public void updateConvertView(RefreshRecyclerviewViewHolder targetViewHolder, int position) {

 ...
 */
public abstract class EasyRegularAdapter<T, BINDHOLDER extends RefreshRecyclerviewViewHolder> extends RefreshViewAdapter {
    ...
    @Override
    public RefreshRecyclerviewViewHolder onCreateHeaderViewHolder(ViewGroup parent) {
        return new RefreshRecyclerviewViewHolder(parent);
    }

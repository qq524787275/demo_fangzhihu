...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    * */
    ...
    RoundRectDrawableWithShadow(Resources resources, int backgroundColor, float radius,
        ...
        mShadowStartColor = resources.getColor(R.color.material_shadow_start_color);
        mShadowEndColor = resources.getColor(R.color.material_shadow_end_color);
        mInsetShadow = resources.getDimensionPixelSize(R.dimen.material_compat_inset_shadow);

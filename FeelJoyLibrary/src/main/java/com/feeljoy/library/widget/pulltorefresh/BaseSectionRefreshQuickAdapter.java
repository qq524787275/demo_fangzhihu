...
import com.feeljoy.library.widget.pulltorefresh.entity.SectionEntity;
 ...
 */
public abstract class BaseSectionRefreshQuickAdapter<T extends SectionEntity> extends BaseRefreshQuickAdapter {
     ...
     */
    public BaseSectionRefreshQuickAdapter(int layoutResId, int sectionHeadResId, List<T> data) {

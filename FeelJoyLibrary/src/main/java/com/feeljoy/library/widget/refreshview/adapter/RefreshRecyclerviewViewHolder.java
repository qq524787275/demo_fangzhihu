...
import com.feeljoy.library.widget.refreshview.swipe.SwipeLayout;
 ...
 */
public class RefreshRecyclerviewViewHolder<T> extends RecyclerView.ViewHolder implements
    ...
    public RefreshRecyclerviewViewHolder(View itemView) {
        super(itemView);

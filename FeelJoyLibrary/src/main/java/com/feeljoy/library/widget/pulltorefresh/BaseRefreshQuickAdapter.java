...
import com.feeljoy.library.widget.pulltorefresh.animation.AlphaInAnimation;
import com.feeljoy.library.widget.pulltorefresh.animation.BaseAnimation;
import com.feeljoy.library.widget.pulltorefresh.animation.ScaleInAnimation;
import com.feeljoy.library.widget.pulltorefresh.animation.SlideInBottomAnimation;
import com.feeljoy.library.widget.pulltorefresh.animation.SlideInLeftAnimation;
import com.feeljoy.library.widget.pulltorefresh.animation.SlideInRightAnimation;
 ...
 */
public abstract class BaseRefreshQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    protected static final String TAG = BaseRefreshQuickAdapter.class.getSimpleName();
    ...
    public interface OnRecyclerViewItemChildClickListener {
        void onItemChildClick(BaseRefreshQuickAdapter adapter, View view, int position);
    }
    ...
    public class OnItemChildClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (mChildClickListener != null)
                mChildClickListener.onItemChildClick(BaseRefreshQuickAdapter.this, v, position - getHeaderViewsCount());
        }
    }
     ...
     */
    public BaseRefreshQuickAdapter(int layoutResId, List<T> data) {
    ...
    public BaseRefreshQuickAdapter(List<T> data) {
        this(0, data);
    }

    public BaseRefreshQuickAdapter(View contentView, List<T> data) {
        this( 0, data);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int positions) {
        ...
        switch (holder.getItemViewType()) {
            case 0:
                convert((BaseViewHolder) holder, getItem(holder.getLayoutPosition() - getHeaderViewsCount()));
            ...
            default:
                convert((BaseViewHolder) holder, getItem(holder.getLayoutPosition() - getHeaderViewsCount()));
                onBindDefViewHolder((BaseViewHolder) holder, getItem(holder.getLayoutPosition() - getHeaderViewsCount()));
                break;
        }
    ...
    /**
     * When the current adapter is empty, the BaseRefreshQuickAdapter can display a special view
